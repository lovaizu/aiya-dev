...
4. Return to base branch and update: `git switch <work-N> && git fetch origin && git merge --ff-only origin/main` then delete task branch: `git push origin --delete <branch-name> && git branch -D <branch-name>`
